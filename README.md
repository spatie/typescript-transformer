...
[![Tests](https://github.com/spatie/typescript-transformer/actions/workflows/run-tests.yml/badge.svg)](https://github.com/spatie/typescript-transformer/actions/workflows/run-tests.yml)
